 ...
 */
var GetUserHandler = /** @class */ (function (_super) {
    __extends(GetUserHandler, _super);
    /**
     ...
     */
    GetUserHandler.prototype.execute = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                }
                catch (error) {
                    monitor_1.Monitor.log(GetUserHandler, error, monitor_1.Monitor.Layer.WARNING);
                    res.status(500).send({
