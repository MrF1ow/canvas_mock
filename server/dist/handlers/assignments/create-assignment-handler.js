 ...
 */
var CreateAssignmentHandler = /** @class */ (function (_super) {
    __extends(CreateAssignmentHandler, _super);
    /**
     * Instantiates a new handler.
     */
    function CreateAssignmentHandler() {
        return _super.call(this, config_1.REQUEST_TYPE.POST, '/') || this;
    }
    /**
     * Handles the request.
     *
     ...
     */
    CreateAssignmentHandler.prototype.execute = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                }
                catch (error) {
                    monitor_1.Monitor.log(CreateAssignmentHandler, error, monitor_1.Monitor.Layer.WARNING);
                    res.status(500).send({
    ...
    return CreateAssignmentHandler;
}(handler_1.Handler));
