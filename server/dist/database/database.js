...
var used_abstract_database_error_1 = __importDefault(require("../errors/used-abstract-database-error"));
/**
...
var Database = /** @class */ (function () {
    function Database() {
         ...
         */
        this.assignments = new dao_1.DataAccessObject();
        /**
         * Data access object for Courses.
         */
        this.courses = new dao_1.DataAccessObject();
        /**
         * Data access object for Submissions.
         */
        this.submissions = new dao_1.DataAccessObject();
        /**
         * Data access object for Users.
         */
        this.users = new dao_1.DataAccessObject();
        /**
         * Data access object for Enrolleds.
         */
        this.enrolled = new dao_1.DataAccessObject();
    }
    /**
    ...
    Database.prototype.connect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new used_abstract_database_error_1.default();
            });
        });
    };
    /**
     ...
     */
    Database.prototype.getDao = function (name) {
        switch (name) {
            default:
                return this.users;
        }
